...
export default function SMEForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/sme/auth/forgot-password', {
        method: 'POST',
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-400 mb-8">
            If an SME account exists for <span className="text-white font-medium">{email}</span>,
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Reset SME Password</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 rounded-2xl p-8 space-y-5 border border-gray-800">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/sme/login" className="text-emerald-400 hover:text-emerald-300">
              Sign In
            </Link>
          </p>
        </form>
